  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 md:p-16 font-sans">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <h1 className="text-5xl font-bold mb-4 tracking-tight">Business Insights</h1>
        ...
        <Card className="bg-zinc-900/50 border-zinc-800 text-white p-6">
          <CardHeader>
            ...
            <p className="text-zinc-400 leading-relaxed">
              Unlock the full potential of your corporate data with deep, informative analytics tailored to your strategic goals. We go beyond surface-level reporting to provide insightful intelligence that reveals hidden patterns, identifies market opportunities, and highlights operational efficiencies. By converting complex data points into clear narratives, we empower your leadership to move from intuition to evidence-based decision-making.
          ...
          <CardContent className="space-y-8 mt-4">
            <div>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-zinc-300">
                <li className="flex items-center gap-2">• Data Discovery</li>
                <li className="flex items-center gap-2">• Predictive Analysis</li>
                <li className="flex items-center gap-2">• Story Telling</li>
                <li className="flex items-center gap-2">• Interactive Dashboard</li>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[ 'Power BI', 'Python', 'DAX', 'Power Query', 'Fiber','Tabula'].map((tech) => (
          ...
          <div className="w-full space-y-12 py-8">
            ...
            <div className="flex items-center justify-between px-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] uppercase tracking-wider text-zinc-500">Dashboard</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] uppercase tracking-wider text-zinc-500 text-center"> Identification</span>
              </div>
              <ArrowRight className="text-zinc-700" />
              <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-center space-y-2">
              <h3 className="text-xl font-semibold"> Get Actionalbe Insights </h3>
...
export default BusinessInslightssPage;
